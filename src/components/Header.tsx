      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center w-full"> {/* w-full for inner container */}
        ...
        {showTelegramButton && (
          <a
            ...
            className="inline-flex items-center px-8 py-4 text-lg font-medium text-white bg-[#0088cc] rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg" // Kept Telegram brand color
          >
